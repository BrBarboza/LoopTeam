...
4. Checagem silenciosa pós-geração: bate com cada regra extraída? Sim → segue entrega normal.
...
6. Diverge global (mudaria identidade visual inteira): PARE, pergunte em 3 linhas — conflito, 2 opções, recomendação.
